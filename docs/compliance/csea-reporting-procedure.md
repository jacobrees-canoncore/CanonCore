...
Portal (CSEA-IRP)**. The portal is for CSEA only; no other crime type may be reported through it.
...
**The cost of this choice, stated plainly:** organisation registration requests are reviewed by the NCA
only during working hours, Monday to Friday 07:00–17:00 excluding bank holidays. If CSEA content is ever
...
2. **If there is a current or imminent risk to a person, call 999 first.** The NCA's own guidance says to
   do this where the provider is not yet registered, rather than waiting on portal access.
...
6. **Do not duplicate an NCMEC report.** If content has already been reported to NCMEC's CyberTipline, do
   not submit a duplicate referral to the NCA.
