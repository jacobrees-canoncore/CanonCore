...
- [1. TMDB (API v3 / v4)](#1-tmdb-api-v3--v4)
  - [Episode groups: the type enum](#episode-groups-the-type-enum)
  - [Response shapes (verbatim field names)](#response-shapes-verbatim-field-names)
  - [Can an episode be in more than one group?](#can-an-episode-be-in-more-than-one-group)
  - [Nesting](#nesting)
  - [Is there a default group?](#is-there-a-default-group)
  - [Alternative cuts and versions](#alternative-cuts-and-versions)
  - [Images](#images)
  - [Terms of use for a public non-commercial app](#terms-of-use-for-a-public-non-commercial-app)
  - [The four questions](#the-four-questions)
- [2. TheTVDB v4 API](#2-thetvdb-v4-api)
  - [Season / order types — the full list](#season--order-types--the-full-list)
  - [Does a series name a default order?](#does-a-series-name-a-default-order)
  - [Can an episode be absent from a given order?](#can-an-episode-be-absent-from-a-given-order)
  - [Does an order get its own named seasons?](#does-an-order-get-its-own-named-seasons)
  - [Endpoint paths, verbatim](#endpoint-paths-verbatim)
  - [Alternative cuts and versions](#alternative-cuts-and-versions-1)
  - [Licensing and API-key terms](#licensing-and-api-key-terms)
  - [The four questions](#the-four-questions-1)
- [3. MusicBrainz](#3-musicbrainz)
  - [The entity model](#the-entity-model)
  - [How audio drama is typed](#how-audio-drama-is-typed)
  - [The Series entity — the ordering mechanism](#the-series-entity--the-ordering-mechanism)
  - [How complete is Big Finish coverage](#how-complete-is-big-finish-coverage)
  - [Licence and rate limits](#licence-and-rate-limits)
  - [The four questions](#the-four-questions-2)
- [4. Open Library](#4-open-library)
  - [Work vs edition](#work-vs-edition)
  - [Novelisations and tie-in fiction](#novelisations-and-tie-in-fiction)
  - [Identifiers](#identifiers)
  - [Coverage of Doctor Who prose — measured live](#coverage-of-doctor-who-prose--measured-live)
  - [Cover images](#cover-images)
  - [Licence and rate limits](#licence-and-rate-limits-1)
  - [The four questions](#the-four-questions-3)
- [5. Wikidata](#5-wikidata)
  - [Cross-source identifier properties](#cross-source-identifier-properties)
  - [Does it model fictional chronology?](#does-it-model-fictional-chronology)
  - [Access limits and licence](#access-limits-and-licence)
  - [The four questions](#the-four-questions-4)
- [6. tardis.wiki](#6-tardiswiki)
  - [Reachability and the Cloudflare challenge](#reachability-and-the-cloudflare-challenge)
  - [What robots.txt says](#what-robotstxt-says)
  - [The licence](#the-licence)
  - [Scale and structure — SemanticMediaWiki is installed](#scale-and-structure--semanticmediawiki-is-installed)
  - [The chronology problem](#the-chronology-problem)
  - [What licence-compliant reuse would actually require](#what-licence-compliant-reuse-would-actually-require)
  - [The four questions](#the-four-questions-5)
- [7. Big Finish's own site](#7-big-finishs-own-site)
  - [Is there a machine-readable surface?](#is-there-a-machine-readable-surface)
  - [What the terms of use say](#what-the-terms-of-use-say)
  - [The four questions](#the-four-questions-6)
